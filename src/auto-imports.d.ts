...
declare global {
  ...
  const AppleTV: typeof import('./components/apps/AppleTV')['default']
  ...
  const DesktopFolders: typeof import('./components/DesktopFolders')['default']
  ...
  const finderNew: typeof import('./components/apps/Finder_new')['default']
  const forwardRef: typeof import('react')['forwardRef']
  const lazy: typeof import('react')['lazy']
  const memo: typeof import('react')['memo']
  const openFolderInFinder: typeof import('./components/apps/Finder')['openFolderInFinder']
  ...
  const useFinderStore: typeof import('./stores/finderStore')['useFinderStore']
